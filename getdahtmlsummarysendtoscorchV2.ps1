...
$DAServer6 = "CHEVDA07.essexcc.local" #to be done today
$DAServer7 = "CHEVDA09.essexcc.local" #to be done today
#$DAServer8 = "CHEVDA10.essexcc.local"
